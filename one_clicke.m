...
global CaSignal
dataPath = 'E:\matlab_workspace\fcn_project_1\training_data\xinyu';
[filename, pathName] = uigetfile(fullfile(dataPath, '*.tif*'), 'Load Image File');
if isequal(filename,0)
	return;
end
CaSignal.imageFilename = filename;
CaSignal.imagePathName = pathName;
[CaSignal.mean_images, CaSignal.max_mean_image] = load_image_data(CaSignal.imagePathName);
CaSignal.max_images = CaSignal.mean_images;
...
[mean_images, max_mean_image] = load_image_data(pathname);
